...
X = readcsv("./InsideGrid/InputInGrid/Observation.csv")		#Inputing the observation matrix of the desired example
micPos = readcsv("./InsideGrid/InputInGrid/MicPosition.csv") # The coordinates of the detectors in the grid
